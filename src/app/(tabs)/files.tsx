...
export default function FilesScreen() {
  ...
  const element = colors?.element ?? "#1f1f1f";
  ...
  function handleLongPress(file: LocalFile) {
    Alert.alert(file.name, `Size: ${formatSize(file.size)}`, [
    ...
    >
      ...
      <View style={[styles.header, { borderBottomColor: border }]}>
        <View style={styles.headerTop}>
          <View>
            <Text style={[styles.headerTitle, { color: text }]}>Files</Text>
      ...
      {loading ? (
        ...
        <View style={[styles.centered, { backgroundColor: bg }]}>
          ...
          <Text style={[styles.emptyTitle, { color: text }]}>No files yet</Text>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={[styles.fileRow, { borderBottomColor: element }]}
              onPress={() =>
                item.isDirectory
            ...
            >
              ...
              <View style={styles.fileInfo}>
                <Text
                  style={[styles.fileName, { color: text }]}
                  numberOfLines={1}
                >
                  {item.name}
                </Text>
                <Text style={[styles.fileMeta, { color: subtext }]}>
