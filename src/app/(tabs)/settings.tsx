...
export default function Settings() {
  ...
  async function handleThemeChange(val: "dark" | "light") {
    setTheme(val);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View>
                  <Text
                    style={[
                      ...
                      provider === p.value && styles.providerLabelActive,
                    ]}
                  >
                    {p.label}
                  </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.keyHint}>
            Your key is stored securely on device using Expo SecureStore. It
        ...
        <View style={styles.section}>
          ...
          <View style={styles.themeRow}>
            ...
            >
              <Text style={styles.themeBtnText}>☀️ Light</Text>
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  themeBtnText: { color: "#FFFFFF", fontWeight: "600" },
});
