...
export default function EditSnippet() {
  ...
  function handleSave() {
    if (!isFormValid()) {
      Alert.alert('Missing Fields', 'Please enter a title and code.');
      return;
    }
    if (!snippet) return;
    try {
      ...
      console.error('[EditSnippet] save error:', e);
    } finally {
      setSaving(false);
    }
  }
          ...
          >
            <View style={styles.favoriteLeft}>
              ...
              <View>
                ...
                <Text style={styles.favoriteSubtitle}>Star for quick access</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  headerButton: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 8, minWidth: 70, alignItems: 'center' },
  ...
  field:        { gap: 8 },
  label:        { fontSize: 11, fontWeight: '700', color: '#f97316', letterSpacing: 1.5 },
  input: {
  ...
  codeInput: {
    ...
    borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12,
    fontSize: 13, color: '#FFFFFF', fontFamily: 'monospace',
    minHeight: 200, textAlignVertical: 'top',
  },
  languageRow:          { gap: 8, paddingVertical: 4 },
  languageChip: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8,
    borderWidth: 1, borderColor: '#2a2a2a', backgroundColor: '#141414',
  },
  languageChipActive:     { borderColor: '#f97316', backgroundColor: '#1f1200' },
  languageIcon:           { fontSize: 14 },
  languageChipText:       { fontSize: 13, color: '#888888' },
  languageChipTextActive: { color: '#f97316', fontWeight: '600' },
  badgePreview:           { marginTop: 4 },
  tagsPreview:            { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 4 },
  tag:                    { backgroundColor: '#1f1f1f', borderRadius: 4, paddingHorizontal: 8, paddingVertical: 3 },
  ...
  favoriteIcon:         { fontSize: 22, color: '#FFD700' },
  favoriteLabel:        { fontSize: 15, fontWeight: '600', color: '#FFFFFF' },
  favoriteSubtitle:     { fontSize: 12, color: '#555555', marginTop: 2 },
  toggle: {
    width: 44, height: 26, borderRadius: 13,
    backgroundColor: '#2a2a2a', justifyContent: 'center', paddingHorizontal: 3,
  },
  toggleActive:         { backgroundColor: '#f97316' },
  toggleThumb:          { width: 20, height: 20, borderRadius: 10, backgroundColor: '#888888' },
